package cn.ubuilding.dolphin;

import cn.ubuilding.dolphin.support.BeanUsedHolder;
import cn.ubuilding.dolphin.support.PlaceholderCollector;
import cn.ubuilding.dolphin.support.PlaceholderChangeEvent;
import cn.ubuilding.dolphin.support.PlaceholderChanger;
...
public class PropertyPlaceholderConfigurer extends PropertySourcesPlaceholderConfigurer implements BeanPostProcessor {
    ...
    public PropertyPlaceholderConfigurer() {
        if (null == this.placeholderCollector)
            this.placeholderCollector = new PlaceholderCollector(this.placeholderPrefix, this.placeholderSuffix);
    }
    ...
    private class BeanPlaceholderChanger implements PlaceholderChanger {
        ...
        public void onChange(PlaceholderChangeEvent event) {
            List<BeanUsedHolder> list = PropertyPlaceholderConfigurer.this.placeholderCollector.getUsedPlaceholder(event.getName());
            if (null != list && list.size() > 0) {
                ...
                for (BeanUsedHolder holder : list) {
                    ...
                    Object bean = PropertyPlaceholderConfigurer.this.beanFactory.getBean(beanName);
                    if (null != bean) {
